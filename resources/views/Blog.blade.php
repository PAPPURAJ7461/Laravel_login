<?php echo View::make('includes/frontend/header'); ?>

    <!-- WELCOME
    ================================================== -->
    <section data-jarallax data-speed=".8" class="py-10 py-md-14 overlay overlay-black overlay-60 bg-cover jarallax" style="background-image: url(assets/dist/img/photo-15.jpg);">
      <div class="container">
          ...
          <div class="col-12">
            ...
            <div class="card card-row shadow-light-lg mb-6 lift lift-lg">
              <div class="row no-gutters">
                ...
                <a class="col-12 col-md-6 order-md-2 bg-cover card-img-right" style="background-image: url(assets/dist/img/photo-27.jpg);" href="#!">

                  <!-- Image (placeholder) -->
                  <img src="assets/dist/img/photo-27.jpg" alt="..." class="img-fluid d-md-none invisible">
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 mb-lg-0 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="assets/dist/img/photo-15.jpg" alt="..." class="card-img-top">
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 mb-lg-0 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="assets/dist/img/photo-14.jpg" alt="..." class="card-img-top">
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 mb-md-0 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="assets/dist/img/photo-7.jpg" alt="..." class="card-img-top">
              ...
              <a class="card-meta mt-auto" href="#!">
                ...
                <!-- Avatar -->
                <div class="avatar avatar-sm mr-2">
                  <img src="{{ url('assets/dist/img')}}/avatar-1.jpg" alt="..." class="avatar-img rounded-circle">
                </div>
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card d-lg-none shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="{{ url('assets/dist/img')}}/photo-5.jpg" alt="..." class="card-img-top">
              ...
              <div class="row no-gutters">
                <div class="col-12 col-md-6">
                  ...
                  <div class="card-img-slider" data-flickity='{"fade": true, "imagesLoaded": true, "pageDots": false, "prevNextButtons": false, "asNavFor": "#blogSlider", "draggable": false}'>
                    <a class="card-img-left w-100 bg-cover" style="background-image: url(assets/dist/img/photo-1.jpg);" href="#!">

                      <!-- Image (placeholder) -->
                      <img src="assets/img/photos/photo-1.jpg" alt="..." class="img-fluid d-md-none invisible">

                    </a>
                    <a class="card-img-left w-100 bg-cover" style="background-image: url(assets/dist/img/photo-26.jpg);" href="#!">

                      <!-- Image (placeholder) -->
                      <img src="{{ url('assets/dist/img')}}/photo-26.jpg" alt="..." class="img-fluid d-md-none invisible">
                  ...
                  <div class="position-static" data-flickity='{"wrapAround": true, "pageDots": false, "imagesLoaded": true, "adaptiveHeight": true}' id="blogSlider">
                    <div class="w-100">
                      ...
                      <a class="card-meta mt-auto" href="#!">
                        ...
                        <!-- Avatar -->
                        <div class="avatar avatar-sm mr-2">
                          <img src="{{ url('assets/dist/img')}}/avatar-2.jpg" alt="..." class="avatar-img rounded-circle">
                        </div>
          ...
          <div class="col-12 col-md-6 d-flex">
            ...
            <div class="card mb-6 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="{{ url('assets/dist/img')}}/photo-28.jpg" alt="..." class="card-img-top">
          ...
          <div class="col-12 col-md-6 d-flex">
            ...
            <div class="card mb-6 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="{{ url('assets/dist/img')}}/photo-29.jpg" alt="..." class="card-img-top">
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 mb-lg-0 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="{{ url('assets/dist/img')}}/photo-6.jpg" alt="..." class="card-img-top">
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card mb-6 mb-lg-0 shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="{{ url('assets/dist/img')}}/photo-4.jpg" alt="..." class="card-img-top">
          ...
          <div class="col-12 col-md-6 col-lg-4 d-flex">
            ...
            <div class="card d-lg-none shadow-light-lg lift lift-lg">
              ...
              <a class="card-img-top" href="#!">
                ...
                <!-- Image -->
                <img src="{{ url('assets/dist/img')}}/photo-27.jpg" alt="..." class="card-img-top">
  ...
  <?php echo View::make('includes/frontend/footer'); ?>