    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div class="media">
              ...
              <div class="media-body">
                <h3 class="dropdown-item-title">
                 @if (Session::has('first_name')) {{ Session::get('first_name').' '.Session::get('last_name')}}
                   @endif
                </h3>
                <p class="text-sm">@if (Session::has('email')) {{ Session::get('email')}}
            @endif</p>
          ...
          <a href="logout" class="dropdown-item text-center text-primary">
            Logout
          </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
               <li class="nav-item">
                <a href="artical_list" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Artical List</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="add_artical" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Artical</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
               <li class="nav-item">
                <a href="cetegory_list" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Cetegory List</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="add_cetegory" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add  Cetegory</p>
                </a>
              </li>
